...
public class MemberService {
    ...
    //회원 가입
    public MemberDTO signUp(SignupDTO signupDTO, final MultipartFile profileImage) {
        ...
        String role = "USER";
        String imageUrl = imageRepository.upload(profileImage);

        return new MemberDTO(memberRepository.save(signupDTO.toEntity(encodedPassword, role, imageUrl)));
    }

    public MemberEntity updateMember(Long userId, MemberUpdateDTO updateDTO, MultipartFile profileImage) {
